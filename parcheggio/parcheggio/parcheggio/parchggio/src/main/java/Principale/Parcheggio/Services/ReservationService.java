...
public class ReservationService {
    ...
    @Transactional
    public Reservation addReservation(long userId, long chargeRequestId, Payment payment) {
        logger.info("Tentativo di aggiungere una prenotazione: User ID: {}, ChargeRequest ID: {}, ParkingSpot ID: {}", userId, chargeRequestId);
        ...
        try {
            ...
            System.out.println(reservation.getParkingSpot());
