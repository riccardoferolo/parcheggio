...
public class MacchineController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Macchine> createMacchina(
            @RequestParam String targa,
            @RequestParam double kwBatteria,
    ...
    @PutMapping("/update")
    public ResponseEntity<Macchine> updateMacchina(
            @RequestParam String targa,
            @RequestParam double kwBatteria,
            @RequestParam String modello) {
    ...
    @GetMapping("/byUser")
    public ResponseEntity<List<Macchine>> getMacchineByUserId(@RequestParam int userId) {
        List<Macchine> macchine = macchineService.getMacchineByUserId(userId);
